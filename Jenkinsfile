pipeline {
  agent any
   environment {
        ...
        env.SEMGREP_APP_TOKEN = '1c87866c63498142b962151e4b3f762e2d7b7b5985048391c299968d474708b8'
   ...
   stage('NPM Clean'){
        steps{
            sh 'npm cache clean --force'
             ...
             sh 'npm run build'
           sh "docker run -e SEMGREP_APP_TOKEN=${env.SEMGREP_APP_TOKEN} --rm -v ${PWD}:/src semgrep/semgrep semgrep ci"
